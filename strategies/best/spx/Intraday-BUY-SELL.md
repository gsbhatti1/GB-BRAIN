...
BUY & SELL Scalp Signals for Crude Oil Future Contracts (or it can be used with any scrip with a good amount of Volume) based on Sma & RSI overbought/oversold alert (!) for possible reversal indication.

Take Buy position only if candle breaks the high of the alert candle, and for Sell positions, take position if candle breaks low of the alert candle.

Best to perform with 3 min timeframe on Crude Oil Futures

**backtest**

![](https://www.fmz.com/upload/asset/ae4be0a059edbbe53b.png)
