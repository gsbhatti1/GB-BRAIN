...
This indicator is based on RSI of two different periods.
...
# In this Indicator #
I see that you can use two RSI with different periods to suggest Bullish trends and Bearish trends.
