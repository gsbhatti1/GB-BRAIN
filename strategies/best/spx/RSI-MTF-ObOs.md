...
//@version=5
indicator("RSI-MTF-ObOs")

//------------------------------------------------------------------------------
// Input
var g_rsi       = "[ RSI SETTING ]"
rsiSrc          = input(close, title="Source", group=g_rsi)
rsiLength       = input.int(14, title="Length", minval=1, group=g_rsi)
rsiOverbought   = input.int(65, title="Overbought", minval=50, maxval=99, step=1, group=g_rsi)
rsiOversold     = input.int(35, title="Oversold", minval=1, maxval=50, step=1, group=g_rsi)

var g_tf        = "[ SELECT TIMEFRAME ]"
rsiTf1          = input.timeframe("15", title="Timeframe 1", group=g_tf, inline="tf1")
rsiTf2          = input.timeframe("30", title="Timeframe 2", group=g_tf, inline="tf2")
rsiTf3          = input.timeframe("60", title="Timeframe 3", group=g_tf, inline="tf3")
rsiTf4          = input.timeframe("120", title="Timeframe 4", group=g_tf, inline="tf4")
rsiTf5          = input.timeframe("240", title="Timeframe 5", group=g_tf, inline="tf5")
rsiTf1_E        = input.bool(true, title="", group=g_tf, inline="tf1")
rsiTf2_E        = input.bool(true, title="", group=g_tf, inline="tf2")
rsiTf3_E        = input.bool(true, title="", group=g_tf, inline="tf3")
rsiTf4_E        = input.bool(true, title="", group=g_tf, inline="tf4")
rsiTf5_E        = input.bool(true, title="", group=g_tf, inline="tf5")
