...
## Overview
This strategy determines long and short positions through customized timeframe buying and selling volume, combined with weekly VWAP and Bollinger Bands for filtering, to achieve high-probability trend tracking. It also introduces a dynamic take profit and stop loss mechanism to effectively control one-sided risk.
...
2. Process buying and selling volumes
- Smooth by 20-period EMA
- Separate processed buying and selling volumes into positive and negative
...
## Risks
1. Buying and selling volume data has certain errors, which may cause misjudgment 
2. Single indicator combined judgment is prone to generate false signals
...
## Conclusion
This strategy fully utilizes the predictability of buying and selling volumes, supplemented by VWAP and Bollinger Bands to generate high-probability signals while effectively controlling risk through dynamic take profit and stop loss mechanisms. As parameters and rules continue to be optimized, performance is expected to become more significant.

||

## Overview
This strategy determines long and short positions using customized timeframe buying and selling volume indicators in combination with weekly VWAP and Bollinger Bands for filtering, achieving high-probability trend tracking. It also introduces a dynamic take profit and stop loss mechanism to effectively control one-sided risk.
