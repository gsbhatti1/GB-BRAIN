...
3. After opening a short position, set trailing stop loss at the lowest closing price. If RSI crosses above 54 or below 32, close the position.
...
1. Test and optimize SMA period and RSI parameters to find the best combination.
