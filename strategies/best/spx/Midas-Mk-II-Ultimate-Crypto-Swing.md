```markdown
Name: Midas-Mk-II-Ultimate-Crypto-Swing

Author: ChaoZhang

Strategy Description:
>> This script is only meant to be used in 4-hour crypto chart <<

How It Works - To swing trade in a 4 hr candles, which has a much larger range than shorter timeframe candles, the script utilizes a longer timeframe EMA, SMA, and MACD to account for such. When the EMA and SMA crosses and the rate of change of the MACD histogram is in favor of the direction, then the system provides a long/short signal.
How To Use - The script works best when the signal aligns with other analyses (trend, harmonic patterns, etc.). This script does not provide any exit signals, so I recommend exiting when the candle breaks out of the structure or using other strategies.
...
Detail: https://www.fmz.com/strategy/362089

Last Modified: 2022-05-09 23:22:05
```