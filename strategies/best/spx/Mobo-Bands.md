...
colorNormLength = input(3, "colorNormLength", type=input.integer)
dpoLength       = input(13, "dpoLength", type=input.integer)
moboDisplace    = input(0, "moboDisplace", type=input.integer)
moboLength      = input(10, "moboLength", type=input.integer)

numDevDn  = input(-0.8, "numDevDn", type=input.float)
numDevUp  = input(0.8, "numDevUp", type=input.float)
