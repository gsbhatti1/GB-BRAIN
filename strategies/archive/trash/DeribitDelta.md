...
Teaching of Deribit Option Delta Dynamic Hedging Strategy
...
## Teaching on the Deribit Option Delta Dynamic Hedging Strategy

Article Address: https://www.fmz.com/bbs-topic/6726
...
|----|----|----|
|isTestNet|true|Switch to test net?|
|testNetBase|https://test.deribit.com|Test net base URL|
|hedgeDeltaStep|true|Delta hedging step size|
|isResetLog|true|Clear logs?|
...
function createManager(e, subscribeList, msg) {
    ...
    self.tickers = []                    // All market data from the API, defined format: {bid1: 123, ask1: 123, symbol: "xxx"}}
    ...
    self.setBase = function(base) {
        // Switch base URL to test net or live environment
        self.e.SetBase(base)
        Log(self.name, self.label, "Switched to test net:", base)
    }
    ...
    self.returnPosTbl = function() {
        ...
        /* Position data format returned by the API
        {
