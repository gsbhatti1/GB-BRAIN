...
The strategy requires constant testing and adjustment, and the parameters are often changed. Stopping and restarting every time is tedious and laborious, and the original profit progress will be lost (although it can also be restored through global parameters). In fact, BotVS has provided a way to dynamically adjust parameters—“Strategy Interaction.”
...
//AAA and BBB are the parameters that you want to dynamically adjust in the strategy
varAAA=0;
var BBB="hello world";
