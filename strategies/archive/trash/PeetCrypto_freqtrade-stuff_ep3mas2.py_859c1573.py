...
class ep3mas2(IStrategy):
    ...
    minimal_roi = {
        #"36000": 0.0,    # non loosing after 25 days
        #"0": 0.
        "0": 100
    }
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                #(dataframe['ema50'].rolling(6).min() > dataframe['ema100'].rolling(6).max()) &
                #(dataframe['macd'] - dataframe['macdsignal'] > 0.1) &
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                #qtpylib.crossed_above(dataframe['close'], dataframe['ema25']) &
