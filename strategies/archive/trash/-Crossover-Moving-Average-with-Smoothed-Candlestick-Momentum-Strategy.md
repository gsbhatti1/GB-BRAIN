...
period: 1d
basePeriod: 1d
exchanges: [{"eid":"Futures_CME","currency":"CME"}]
```

> Disclaimer

The content provided is for informational purposes only and should not be considered as investment advice. Trading involves risk, including the loss of principal.