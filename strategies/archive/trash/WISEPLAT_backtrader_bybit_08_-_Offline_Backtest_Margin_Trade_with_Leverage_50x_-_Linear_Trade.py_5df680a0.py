# SOURCE: https://github.com/WISEPLAT/backtrader_bybit
# FILE  : 08 - Offline Backtest Margin Trade with Leverage 50x - Linear Trade.py
...
if __name__ == '__main__':
    ...
    data = store.getdata(timeframe=bt.TimeFrame.Days, compression=1, dataname=symbol, start_date=from_date, LiveBars=False, rows_by_request=1000)  # set True here - if you need to get live bars
    data2 = store.getdata(timeframe=bt.TimeFrame.Days, compression=1, dataname=symbol2, start_date=from_date, LiveBars=False, rows_by_request=1000)  # set True here - if you need to get live bars
