...
STRATEGY NOTES:
    - It is recommended to configure protections *if/as* you will use them in live and run a hyperopt/backtest with
...
class Solipsis(IStrategy):
    ...
    # These changes can only be tested in dry-run or live trading
    custom_active_trade = {
