...
// Do not make buy or sell decisions based on this strategy.
// Bu strateji sadece pine script'te kodlamanın nasıl yapildigini ogrenmek icindir.
// Bu stratejiye dayanarak kesinlikle al-sat islemeleri yapmayin.
...
plot(awesome, style=plot.style_histogram, color=color.new(color.green, 0) when awesome > awesome[1] else color.new(color.red, 0))
