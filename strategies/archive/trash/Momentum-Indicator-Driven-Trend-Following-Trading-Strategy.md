...
This strategy builds trading signals based on momentum indicators such as RSI and the price's Exponential Moving Average (EMA) and Simple Moving Average (SMA). It falls into the category of trend-following strategies.

## Strategy Principle

The strategy uses three conditions to generate trading signals:

1. RSI > 45: An RSI value greater than 45 is considered a good buy signal.
2. EMA(RSI) > SMA(RSI): The EMA line being greater than the SMA line indicates RSI is accelerating upwards, which is a good momentum signal.
3. EMA(close) > SMA(close): The EMA line being greater than the SMA line indicates the price trend is accelerating upwards.

Meeting any two of the above three conditions generates a buy signal; if none are met, a sell signal is generated.

The strategy also provides an "always buy" mode for testing the system's performance relative to the broad market.

## Advantage Analysis

1. Using the momentum indicator RSI to judge market conditions can reduce positions during market fluctuations.
...
4. Provides an "always buy" mode to test system advantages.

## Risk Analysis

1. Relies on parameter settings; improper parameters may result in frequent trading or missed opportunities.
2. Major news in the broad market can cause significant price volatility in the short term, leading to stop losses.
3. The strategy itself cannot judge when a trend is about to reverse; other indicators may be needed to determine.

## Optimization Directions

1. Optimize parameters of RSI, EMA, and SMA to find the best parameter combination.
2. Increase other technical indicators such as Volume, MACD, etc., to enrich rule conditions.
3. Increase trend reversal indicators to reduce the probability of losses.

## Conclusion

Overall, this strategy is a medium-frequency trading strategy aimed at capturing mid-term price trends while avoiding short-term market fluctuations. Its advantages and risk points are quite clear. Through parameter optimization and rule enrichment, it can further enhance the strategy's stability, making it a worthwhile high-efficiency quantitative trading strategy to research and optimize.
...
In summary, this strategy is a medium-frequency trading strategy that aims to capture mid-term price trends while avoiding short-term market fluctuations. Its advantages and risk points are quite clear. Further enhancing stability through parameter optimization and enriching rules makes it a worthwhile high-efficiency quantitative trading strategy to research and optimize.
...
if(strategy.position_size != 0)
    strategy.exit("TP/SL", "Long", trail_stop=(SL_Factor * close), trail_offset=TPFactor * close)
```