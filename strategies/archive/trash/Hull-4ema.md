...
plotshape(ShowBuySellArrows ? MA_Min : na, "Buy", shape.triangleup, location.belowbar, color=color.green, text="Buy", offset=-1)
plotshape(ShowBuySellArrows ? MA_Max : na, "Sell", shape.triangledown, location.abovebar, color=color.red, text="Sell", offset=-1)
...
len = input(defval=2, minval=1, title="MA - Exponential")
