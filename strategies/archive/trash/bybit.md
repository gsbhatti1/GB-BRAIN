...
bybit Reversal Contract Dynamic Grid Special Grid
...
let pricesChart = Chart([ // This chart in JS language is an object. Before using the Chart function, we need to declare a variable for configuring the chart.
    {
        __isStock: true, // Mark whether it is a general chart. Interested can change this to false and run to see the difference.
        tooltip: {
        ...
        xAxis: {
            type: 'datetime'
        }, // X axis, the current type is set to : time.
...
Note: The code snippet was cut off at the end. Please complete it as needed.