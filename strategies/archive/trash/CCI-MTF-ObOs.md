...
It can detect overbought and oversold levels up to 5 timeframes, which helps traders spot potential reversal points more easily.

There are options to select 1-5 timeframes to detect overbought and oversold conditions.
...
//------------------------------------------------------------------------------
// CCI Overbought and Oversold detection
...
hline   (cciOversold,          title="CCI Oversold",    color=color.new(color.white, 0),   linestyle=hline.style_dashed, linewidth=1)

bgcolor (cciOb ? color.new(color.red, 0)  : na, title="Overbought")
bgcolor (cciOs ? color.new(color.green, 0): na, title="Oversold")
