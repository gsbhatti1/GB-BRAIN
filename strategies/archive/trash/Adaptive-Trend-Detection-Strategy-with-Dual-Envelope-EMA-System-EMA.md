...
//------------------------------------------------------------------------------
// Example:
// - If bull > bear, enter long position (bullish power greater than bearish)
// - If bear > bull, enter short position (bearish power greater than bullish)
//
// With pyramiding=0, only one position is opened – if the opposite signal comes,
