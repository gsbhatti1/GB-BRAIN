...
For those who are using charts with a white background, they should change the indicator options->style to white color.
OB/OS zones are set at 200 and -200 and marked with aqua color above and below the candles.

**backtest**

![](https://www.fmz.com/upload/asset/18996ab5d6508b3a4cb.png)
...
up = ta.ema(rk6, nn)
down = ta.ema(up, nn)
Oo = if up < down then up else down
Hh = Oo
Ll = if up < down then down else up
Cc = Ll
