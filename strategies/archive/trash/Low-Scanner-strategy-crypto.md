...
los = per(stoploss)
q1=input(title="Qty Percent 1", defval=25, minval=1)
q2=input(title="Qty Percent 2", defval=25, minval=1)
q3=input(title="Qty Percent 3", defval=25, minval=1)
tp1=input(title="Take Profit 1", defval=1, minval=0.01)
tp2=input(title="Take Profit 2", defval=2, minval=0.01)
tp3=input(title="Take Profit 3", defval=3, minval=0.01)
tp4=input(title="Take Profit 4", defval=5, minval=0.01)
...
Detail: [https://www.fmz.com/strategy/366538](https://www.fmz.com/strategy/366538)

Last Modified: 2022-05-29 20:48:52
```