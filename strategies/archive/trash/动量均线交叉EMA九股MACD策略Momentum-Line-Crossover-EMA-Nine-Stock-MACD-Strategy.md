...
This strategy comprehensively utilizes the EMA (Exponential Moving Average) indicator, Bollinger Bands indicator, and MACD (Moving Average Convergence Divergence) indicator. By implementing the golden cross and death cross of the 9-day EMA and 30-day EMA, it combines the price distribution range and momentum indicators to determine the timing of buying and selling.

## Strategy Principle

1. Calculate the 3-day EMA, 9-day EMA, and 30-day EMA.

2. Calculate the standard deviation within 20 days of the price and draw 1 and 2 times the standard deviation Bollinger Bands.

3. Calculate the 12-day and 26-day MACD and the 9-day signal line.

4. When the 9-day EMA crosses above the 30-day EMA, and the price exceeds the upper limit of the 1x standard deviation Bollinger Bands, a buy signal is issued.

5. When the 30-day EMA crosses below the 9-day EMA, and the price is lower than the lower limit of the 1x standard deviation Bollinger Bands, a sell signal is issued.

## Advantage Analysis

By combining the EMA and momentum indicators, this strategy can effectively grasp market trends and timing, with the following advantages:

1. The EMA indicator can quickly respond to price changes and determine market trends; the MACD indicator can identify momentum to prevent false breakouts.
...
plot(ema9Value, title="9 EMA", color=color.blue)
plot(ema30Value, title="30 EMA", color=color.purple)
```