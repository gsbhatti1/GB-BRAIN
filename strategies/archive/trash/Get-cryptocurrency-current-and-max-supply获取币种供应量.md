...
Get-cryptocurrency-current-and-max-supply gets the currency supply
...
Use the API interface provided by coinmarketcap to obtain currency supply and circulation, which can be used to calculate the total market value
