...
![](https://www.fmz.com/upload/asset/c3049b5140ba230397.jpg)
...
```pinescript
//@version=5
indicator("Fibonacci Progression With Breaks [LUX]", overlay=true, max_labels_count=500, max_lines_count=500)
...
// Distance calculation based on method selected
if method == 'Atr'
