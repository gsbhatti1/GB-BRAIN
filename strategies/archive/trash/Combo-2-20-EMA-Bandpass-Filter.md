...
First Strategy:
This indicator plots the 2/20 exponential moving average. For the EMA X 2/20 Indicator, an EMA bar will be painted when the Alert criteria is met.
...
//
// First Strategy:
// This indicator plots the 2/20 exponential moving average. For the EMA 
// X 2/20 Indicator, an EMA bar will be painted when the Alert criteria is met.
//
// Second Strategy:
