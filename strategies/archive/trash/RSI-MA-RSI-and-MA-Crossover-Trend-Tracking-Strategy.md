...
The strategy employs two MAs with periods of 12 and 26. When the 12-period fast MA crosses above the 26-period slow MA, it signals an upward trend; conversely, it indicates a downward trend when the fast MA crosses below the slow MA. The strategy goes long on golden crossover and goes short on death crossover of the two MAs.

The RSI indicator is also used to determine overbought/oversold zones. Only when RSI is higher than its 26-period MA will the strategy open long positions on golden crossover. And only when RSI is lower will it open short positions on death crossover. This avoids forced entries against overbought or oversold situations and hence controls risks.
...
if (longEMA and (rsi(close, 14) > ema(rsi(close, 14),26))) 
