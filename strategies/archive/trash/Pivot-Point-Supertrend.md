...
There are many types of SuperTrend available. Recently, I thought about a Supertrend based on Pivot Points and wrote the "Pivot Point SuperTrend" script. It appears that it performs better in keeping you within the trend.

The idea behind this script is to find pivot points, calculate their average, and create higher/lower bands using ATR as in the standard Supertrend. As you can see from the algorithm, the script gives weight to past pivot points to smooth out the results slightly.
