# SOURCE: https://github.com/WISEPLAT/backtrader_binance
# FILE  : 05 - Offline Backtest MultiPortfolio.py
            ...
            if status in [0, 1]:
                ...
                if not self.getposition(data):  # If there is no position
                    ...
                    if self.rsi[ticker] < 30:  # Enter long
                        ...
                        if data._name == "BNBUSDT": size = 0.01
...
if __name__ == '__main__':
    ...
    for _symbol in symbols:  # Running through all the tickers
        ...
        symbol = _symbol + coin_target  # the ticker by which we will receive data in the format <CodeTickerBaseTicker>
