...
This article explains in detail a quantitative trading strategy that utilizes multi-indicator confirmation to generate trading signals. It combines different techniques to improve reliability.
...
if (possig == 0) 
    strategy.close_all()
barcolor(possig == -1 ? #b50404: possig == 1 ? #079605 : #0536b
```