...
The Dual Moving Average Trading Strategy (Dual-Moving-Average-Trading-Strategy) is a quantitative trading strategy that constructs trading signals using two moving average lines with different cycles. This strategy judges market trends and opportunities by calculating the relationship between the two moving average lines and has good tracking performance in trending markets.
