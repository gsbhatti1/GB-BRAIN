...
|v_input_float_1|1.5|Risk-reward ratio|
|v_input_int_1|20|Body length ratio (%) of upper and lower shadows|
|v_input_float_2|0.5|Percentage change of key candlestick ( % )|
...
length = 14
smoothing = 'RMA'
m = input(2, 'ATR multiple', group = "User-defined parameters")
src1 = high
src2 = low
pline = true
...
rewardRiskRatio = input.float(defval = 1.5, title = "Risk-reward ratio", minval = 1, maxval = 15, step = 0.1, group = "User-defined parameters")
highLowShadowRatio = input.int(defval = 20, title = "Body length ratio (%) of upper and lower shadows", minval = 1, maxval = 100, step = 1, group = "User-defined parameters")
keyCandlestickChange = input.float(defval = 0.5, title = "Percentage change of key candlestick ( % )", minval = 0.1, maxval = 100, step = 0.1, group = "User-defined parameters")
