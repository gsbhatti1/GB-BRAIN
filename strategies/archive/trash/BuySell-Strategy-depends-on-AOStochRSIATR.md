Translate the following trading strategy document from Chinese to English. Keep all code blocks, numbers, and formatting exactly as-is. Only translate the human-readable text.
...
This strategy is just for training; its purpose is just learning how to write code in Pine Script.
Do not make buy or sell decisions with this strategy.
...
When RSI and Stoch are in the oversold area and if the Awesome Oscillator turns positive, take a long position. Stop loss and take profit levels were defined using the ATR indicator.

When RSI and Stoch are in the overbought area and if the Awesome Oscillator turns negative, take a short position. Stop loss and take profit levels were defined using the ATR indicator.

Turkish/Turkce

RSI ve Stoch asırdıktan bir satım bölgelerinde iken awesome pozitife dönse long pozisyon açılır, zarar kesme ve kazanç al seviyeleri ATR indikatörü ile tanımlandı.

RSI ve Stoch asırdıktan bir alım bölgelerinde iken awesome negatife dönse short pozisyon açılır, zarar kesme ve kazanç al seviyeleri ATR indikatörü ile tanımlandı.
...
// Do not make buy or sell decision with this strategy.
// Bu strateji sadece pine script'te kodlamanın nasıl yapildigini ogrenmek icindir.
// Bu stratejiye dayanarak, kesinlikle al-sat islemleri yapmayin.
