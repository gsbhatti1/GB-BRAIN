...
col1 = input(color.blue, "ATR Text Color", inline="1")
...
sl_breakeven_price_activated1 = ta.lowest(low, strategy.position_size == 0 ? nz(strategy.opentrades.entry_bar_index(0), 1):bar_index - strategy.opentrades.entry_bar_index(0)) < activate_breakeven_sl_price1 ? true : false //checks if 1:1 ratio has been reached
...
This translation maintains the original Pine Script code blocks and formatting while translating the human-readable text.