...
At any point of time, you will see up to 4 trend lines in this script.
...
![](https://www.fmz.com/upload/asset/973700b783234a7238.png)
...
hma3() => p = length/2, wma(wma(close, p/3)*3 - wma(close, p) - wma(close, p), p)
