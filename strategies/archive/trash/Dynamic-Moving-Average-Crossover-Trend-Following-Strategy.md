...
//@version=5
strategy("Trading Strategy (Customizable EMA/SMA Parameters)", overlay=true, initial_capital=100000, currency=currency.EUR, default_qty_type=strategy.percent_of_equity, default_qty_value=10)

// Input parameters: customizable SMA and EMA periods
