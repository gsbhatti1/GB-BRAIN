...
This strategy uses Double Exponential Moving Average (DEMA) to calculate price volatility and further smooths the volatility to detect trends in price fluctuations. It goes long when volatility rises and short when volatility falls.
...
3. Apply DEMA smoothing on volatility again to get trend signal
