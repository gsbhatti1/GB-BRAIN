...
// Alert for buy and sell signals
alertcondition(macdLine > signalLine and macdLine < 0, title="Buy Signal", message="Buy Signal Generated!")
alertcondition(macdLine < signalLine and macdLine > 0, title="Sell Signal", message="Sell Signal Generated!")

if (showDots)
    label.new(x=bar_index, y=dotsDistance, textcolor=color.white, text="▲")
    label.new(x=bar_index, y=-dotsDistance, textcolor=color.white, text="▼")

// Plot histogram
plot(histogram, color=histogram > 0 ? green : red, title="MACD Histogram")
```