# SOURCE: https://github.com/crashzanders/AutoUpdateNFIX2
# FILE  : update_strategy_pairlist.py

#!/usr/bin/env python3
#
## AutoUpdateNFIX2 : Strategy + Pairlist
# Author : crashzanders
# Version : 1.3
...
from config import url, url_pairlist, file, file_pairlist, command, bot_token, chat_id
