```plaintext
Name: Crodls-Supertrend

Author: ChaoZhang

Strategy Description:
This Indicator uses the Supertrend with three different inputs as confirmation, along with a 200 EMA to provide data for an up or down trend. It then looks for Stochastic (Stoch) indicator confirmation of a cross under 30 for a long position and above 70 for a short position.

**Backtest**
![](https://www.fmz.com/upload/asset/714409a2e72aade205.png)
...
> Last Modified: 2022-05-13 17:43:21
```