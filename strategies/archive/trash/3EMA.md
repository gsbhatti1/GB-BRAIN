...
| v_input_int_2 | 50 | Mid-term moving average |
...
short = input.int(20, "Short-term moving average")
mid = input.int(50, "mid-term moving average")
long = input.int(100, "Long-term moving average")
