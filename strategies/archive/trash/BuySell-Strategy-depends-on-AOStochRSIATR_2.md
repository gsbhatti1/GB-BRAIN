...
Turkish/Turkce
Bu strateji sadece pine script'te kodlamanın nasıl yapılıp getirildiğini öğrenmek için kullanılır. Bu stratejiyle kesin olarak al-ve-sat kararları verme.
Bu stratejiye dayanarak, kesinlikle al-sat işlemlerini yapmayın.
...
When RSI and Stoch are in overbought area and if awesome osc. turns negative, take short position. Stop loss and take profit levels were defined with ATR ind.

Turkish/Turkce

RSI ve Stoch asırı satım bölgelerinde iken awesome pozitife dönse long pozisyon açar, zarar kes ve kar al seviyeleri ATR indikatörü ile tanımlandı.

RSI ve Stoch asırı alım bölgelerinde iken awesome negatife dönse short pozisyon açar, zarar kes ve kar al seviyeleri ATR indikatörü ile tanımlandı.
...
// This strategy is just for training, its purpose is just learning code in pine script.
// Don't make buy or sell decision with this strategy.
// Bu strateji sadece pine script'te kodlamanın nasıl yapılıp getirildiğini öğrenmek için kullanılır. 
// Bu stratejiye dayanarak, kesinlikle al-sat işlemleri yapmayın.
