...
2. Check if the previous 3 candlesticks are green candles, i.e., the close price is higher than the open price
...
6. Set take profit at the entry price plus the distance from the entry to the stop loss
