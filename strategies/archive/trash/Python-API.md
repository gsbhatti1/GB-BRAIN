...
def main():
    ...
    if ok:
        print("Go GetTicker", ret)
        print("EMA", len(talib.EMA(exchange.GetRecords())))
        print("EMA H1", len(talib.EMA(exchange.GetRecords(period=PERIOD_H1))))

    # test plot image
    plt.plot([3,6,2,4,7,1])
    print('Supports direct printing of plt pictures', plt)
