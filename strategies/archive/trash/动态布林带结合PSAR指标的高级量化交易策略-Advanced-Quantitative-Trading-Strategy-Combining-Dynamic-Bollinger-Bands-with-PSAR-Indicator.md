...
// Parameters of the Bollinger Bands
...
// Variables to maintain the maximum and minimum take-profit
var float max_tp = na
var float min_tp = na
...
if (long_condition and time_condition)
    ...
    stop_loss = low      // Stop loss at the candle's low
    take_profit = entry_price + 3 * (entry_price - stop_loss)  // Take profit with a 1:3 risk-reward ratio
