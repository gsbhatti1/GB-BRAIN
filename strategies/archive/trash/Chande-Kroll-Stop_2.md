...
Hereby a script where I created a simple strategy using the underappreciated Chande Kroll stop indicator. A short signal is generated when the close crosses below the orange line, and a long signal is produced upon a crossover of the close candle with the blue line.
