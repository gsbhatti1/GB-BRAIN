...
MA Single Moving Average Trend Trading
...
Strategy description: Go long when the moving average goes up, go short when the moving average goes down, Bitcoin only goes long
